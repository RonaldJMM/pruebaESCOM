--------------------------------------------------------
-- Archivo creado  - martes-abril-14-2020   
--------------------------------------------------------
...
DROP SEQUENCE "USER_ESCOM"."TBL_COMPETITION_GENERAL_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_COMPETITION_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_CONDITION_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_DISTINCTIVE_FEATURE_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_DOCUMENT_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_DOCUMENT_VERSION_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_GENERAL_PROGRAM_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_OCCUPATIONAL_PROFILE_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PROCESS_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PROFESSIONAL_PROFILE_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PROGRAM_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PT_COMPETITION_G_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PT_DISTINCTIVE_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PT_OCCUPATIONAL_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PT_PROFESSIONAL_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_PT_THEMATIC_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_THEMATIC_CORE_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_THEMATIC_SEQ";
DROP SEQUENCE "USER_ESCOM"."TBL_TRAINING_AREA_SEQ";
...
DROP TABLE "USER_ESCOM"."TBL_GENERAL_PROGRAM" cascade constraints;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "USER_ESCOM"."SEQ_GEN_IDENTITY"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 438 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence TBL_COMPETITION_GENERAL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_COMPETITION_GENERAL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_COMPETITION_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_COMPETITION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence TBL_DISTINCTIVE_FEATURE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_DISTINCTIVE_FEATURE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence TBL_GENERAL_PROGRAM_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_GENERAL_PROGRAM_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_OCCUPATIONAL_PROFILE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_OCCUPATIONAL_PROFILE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence TBL_PROFESSIONAL_PROFILE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_PROFESSIONAL_PROFILE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence TBL_PROGRAM_THEMATIC_CORE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_PT_COMPETITION_G_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_PT_COMPETITION_G_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_PT_DISTINCTIVE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_PT_DISTINCTIVE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_PT_OCCUPATIONAL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_PT_OCCUPATIONAL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_PT_PROFESSIONAL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_PT_PROFESSIONAL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_PT_THEMATIC_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_PT_THEMATIC_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_THEMATIC_CORE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_THEMATIC_CORE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_THEMATIC_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_THEMATIC_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_TRAINING_AREA_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USER_ESCOM"."TBL_TRAINING_AREA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TBL_GENERAL_PROGRAM
--------------------------------------------------------

  CREATE TABLE "USER_ESCOM"."TBL_GENERAL_PROGRAM" 
   (	"PK_GP_ID" NUMBER, 
	"GP_NAME" VARCHAR2(200 BYTE), 
	"GP_DESCRIPTION" VARCHAR2(500 BYTE), 
	"GP_STATE" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE" 
   (	"PK_PT_ID" NUMBER, 
	...
	"PT_OBJECTIVE" VARCHAR2(500 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
Insert into USER_ESCOM.TBL_ACTIVITY (PK_ACT_ID,ACT_NAME,ACT_DESCRIPTION,ACT_STATE,FK_ACT_CONDITION,FK_ACT_ANNEX,ACT_TYPE,ACT_NUMBER,ACT_PARENT_ACTIVITY) values ('274','Prueba','prueba','1','162','276','2',null,'0');
...
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_COMPETITION (PK_CT_ID,CT_NAME,FK_CT_GENERAL) values ('376','peueba ','1');
REM INSERTING into USER_ESCOM.TBL_COMPETITION_GENERAL
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_COMPETITION_GENERAL (PK_CG_ID,CG_NAME,FK_CG_COMPETITION) values ('329','sdasdasdas',null);
Insert into USER_ESCOM.TBL_COMPETITION_GENERAL (PK_CG_ID,CG_NAME,FK_CG_COMPETITION) values ('330','assasasas',null);
Insert into USER_ESCOM.TBL_COMPETITION_GENERAL (PK_CG_ID,CG_NAME,FK_CG_COMPETITION) values ('331','asdasdaa',null);
Insert into USER_ESCOM.TBL_COMPETITION_GENERAL (PK_CG_ID,CG_NAME,FK_CG_COMPETITION) values ('377','compe','376');
...
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_DISTINCTIVE_FEATURE (PK_DF_ID,DF_NAME,FK_DF_GENERAL) values ('388','agregar un dis','1');
Insert into USER_ESCOM.TBL_DISTINCTIVE_FEATURE (PK_DF_ID,DF_NAME,FK_DF_GENERAL) values ('391','probando','1');
REM INSERTING into USER_ESCOM.TBL_DOCUMENT
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_DOCUMENT (PK_DOC_ID,DOC_DESCRIPTION,DOC_TYPE,DOC_STATE,FK_DOC_PROGRAM,FK_DOC_USER) values ('158','Renovación ','Renovación ','1','152','223');
REM INSERTING into USER_ESCOM.TBL_DOCUMENT_VERSION
SET DEFINE OFF;
REM INSERTING into USER_ESCOM.TBL_GENERAL_PROGRAM
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_GENERAL_PROGRAM (PK_GP_ID,GP_NAME,GP_DESCRIPTION,GP_STATE) values ('399','prueba ','prueba asdasdasd','-1');
Insert into USER_ESCOM.TBL_GENERAL_PROGRAM (PK_GP_ID,GP_NAME,GP_DESCRIPTION,GP_STATE) values ('400','prue','perp','-1');
Insert into USER_ESCOM.TBL_GENERAL_PROGRAM (PK_GP_ID,GP_NAME,GP_DESCRIPTION,GP_STATE) values ('1','Ingeniería de telecomunicación','Rama de la ingeniería que resuelve problemas de transmisión y recepción de señales e interconexión de redes. Es la disciplina de aplicación de la telecomunicación','1');
REM INSERTING into USER_ESCOM.TBL_OCCUPATIONAL_PROFILE
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_OCCUPATIONAL_PROFILE (PK_OP_ID,OP_NAME,FK_OP_GENERAL) values ('386','Perfil 1','1');
Insert into USER_ESCOM.TBL_OCCUPATIONAL_PROFILE (PK_OP_ID,OP_NAME,FK_OP_GENERAL) values ('387','perfil 2','1');
REM INSERTING into USER_ESCOM.TBL_PROCESS
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_PROCESS (PK_PRC_ID,PRC_NAME,PRC_DESCRIPTION,FK_PRC_DOCUMENT,PRC_STATE) values ('160','Programa','Condiciones de calidad del programas','158','1');
...
Insert into USER_ESCOM.TBL_PROCESS (PK_PRC_ID,PRC_NAME,PRC_DESCRIPTION,FK_PRC_DOCUMENT,PRC_STATE) values ('159','Identificación','Identificación institucional ','158','-1');
Insert into USER_ESCOM.TBL_PROCESS (PK_PRC_ID,PRC_NAME,PRC_DESCRIPTION,FK_PRC_DOCUMENT,PRC_STATE) values ('418','prueba ','prueba 2','158','-1');
REM INSERTING into USER_ESCOM.TBL_PROFESSIONAL_PROFILE
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_PROFESSIONAL_PROFILE (PK_PP_ID,PP_NAME,FK_PP_GENERAL) values ('389','perfila','1');
Insert into USER_ESCOM.TBL_PROFESSIONAL_PROFILE (PK_PP_ID,PP_NAME,FK_PP_GENERAL) values ('390','profesional','1');
REM INSERTING into USER_ESCOM.TBL_PROGRAM
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_PROGRAM (PK_PRO_ID,PRO_NAME,PRO_LEVEL_EDUCATION,PRO_METHODOLOGY,PRO_ACADEMIC_CREDITS,PRO_DURATION,PRO_INSTITUTION,PRO_CAMPUS,FK_PRO_GENERAL,PRO_STATE) values ('406','dasdasda|','adasdasda','adsdasda','11','1','asdasda','safasfs','1','-1');
Insert into USER_ESCOM.TBL_PROGRAM (PK_PRO_ID,PRO_NAME,PRO_LEVEL_EDUCATION,PRO_METHODOLOGY,PRO_ACADEMIC_CREDITS,PRO_DURATION,PRO_INSTITUTION,PRO_CAMPUS,FK_PRO_GENERAL,PRO_STATE) values ('152','Especialización en gerencia de las tecnologías de la información y las comunicaciones - tic','Especialización ','Presencial','30','2','ESCUELA DE COMUNICACIONES MILITARES- ESCOM','Facatativa','1','1');
Insert into USER_ESCOM.TBL_PROGRAM (PK_PRO_ID,PRO_NAME,PRO_LEVEL_EDUCATION,PRO_METHODOLOGY,PRO_ACADEMIC_CREDITS,PRO_DURATION,PRO_INSTITUTION,PRO_CAMPUS,FK_PRO_GENERAL,PRO_STATE) values ('407','profasda','profasda','profasda','12','12','profasda','profasda','1','-1');
Insert into USER_ESCOM.TBL_PROGRAM (PK_PRO_ID,PRO_NAME,PRO_LEVEL_EDUCATION,PRO_METHODOLOGY,PRO_ACADEMIC_CREDITS,PRO_DURATION,PRO_INSTITUTION,PRO_CAMPUS,FK_PRO_GENERAL,PRO_STATE) values ('405','sgggg','ggggg','ggggg','12','12','asdasd','sssssd','1','-1');
...
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_THEMATIC_CORE (PK_TC_ID,TC_NAME,TC_CREDITS,FK_TC_TRAINING_AREA) values ('408','materia','1','370');
REM INSERTING into USER_ESCOM.TBL_TRAINING_AREA
SET DEFINE OFF;
Insert into USER_ESCOM.TBL_TRAINING_AREA (PK_TA_ID,TA_NAME,FK_TA_GENERAL) values ('370','Pruebarea','1');
...
Insert into USER_ESCOM.TBL_USER_CONDITION (PK_UC_ID,FK_UC_USER,FK_UC_CONDITION) values ('298','283','177');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index TBL_GENERAL_PROGRAM_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "USER_ESCOM"."TBL_GENERAL_PROGRAM_PK" ON "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
--  DDL for Trigger TBL_COMPETITION_GENERAL_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_COMPETITION_GENERAL_TRG" 
BEFORE INSERT ON TBL_COMPETITION_GENERAL 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_CG_ID IS NULL THEN
      SELECT TBL_COMPETITION_GENERAL_SEQ.NEXTVAL INTO :NEW.PK_CG_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_COMPETITION_GENERAL_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_COMPETITION_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_COMPETITION_TRG" 
BEFORE INSERT ON TBL_COMPETITION 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_CT_ID IS NULL THEN
      SELECT TBL_COMPETITION_SEQ.NEXTVAL INTO :NEW.PK_CT_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_COMPETITION_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TBL_DISTINCTIVE_FEATURE_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_DISTINCTIVE_FEATURE_TRG" 
BEFORE INSERT ON TBL_DISTINCTIVE_FEATURE 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_DF_ID IS NULL THEN
      SELECT TBL_DISTINCTIVE_FEATURE_SEQ.NEXTVAL INTO :NEW.PK_DF_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_DISTINCTIVE_FEATURE_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TBL_GENERAL_PROGRAM_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_GENERAL_PROGRAM_TRG" 
BEFORE INSERT ON TBL_GENERAL_PROGRAM 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_GP_ID IS NULL THEN
      SELECT TBL_GENERAL_PROGRAM_SEQ.NEXTVAL INTO :NEW.PK_GP_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_GENERAL_PROGRAM_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_OCCUPATIONAL_PROFILE_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_OCCUPATIONAL_PROFILE_TRG" 
BEFORE INSERT ON TBL_OCCUPATIONAL_PROFILE 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_OP_ID IS NULL THEN
      SELECT TBL_OCCUPATIONAL_PROFILE_SEQ.NEXTVAL INTO :NEW.PK_OP_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_OCCUPATIONAL_PROFILE_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TBL_PROFESSIONAL_PROFILE_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_PROFESSIONAL_PROFILE_TRG" 
BEFORE INSERT ON TBL_PROFESSIONAL_PROFILE 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_PP_ID IS NULL THEN
      SELECT TBL_PROFESSIONAL_PROFILE_SEQ.NEXTVAL INTO :NEW.PK_PP_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_PROFESSIONAL_PROFILE_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_PROGRAM_THEMATIC_CORE_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE_TRG" 
BEFORE INSERT ON TBL_PROGRAM_THEMATIC_CORE 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_PT_ID IS NULL THEN
      SELECT TBL_PROGRAM_THEMATIC_CORE_SEQ.NEXTVAL INTO :NEW.PK_PT_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TBL_PT_COMPETITION_G_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_PT_COMPETITION_G_TRG" 
BEFORE INSERT ON TBL_PT_COMPETITION_G 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_PTC_ID IS NULL THEN
      SELECT TBL_PT_COMPETITION_G_SEQ.NEXTVAL INTO :NEW.PK_PTC_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_PT_COMPETITION_G_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_PT_DISTINCTIVE_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_PT_DISTINCTIVE_TRG" 
BEFORE INSERT ON TBL_PT_DISTINCTIVE 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_PTD_ID IS NULL THEN
      SELECT TBL_PT_DISTINCTIVE_SEQ.NEXTVAL INTO :NEW.PK_PTD_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_PT_DISTINCTIVE_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_PT_OCCUPATIONAL_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_PT_OCCUPATIONAL_TRG" 
BEFORE INSERT ON TBL_PT_OCCUPATIONAL 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_PTO_ID IS NULL THEN
      SELECT TBL_PT_OCCUPATIONAL_SEQ.NEXTVAL INTO :NEW.PK_PTO_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_PT_OCCUPATIONAL_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_PT_PROFESSIONAL_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_PT_PROFESSIONAL_TRG" 
BEFORE INSERT ON TBL_PT_PROFESSIONAL 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_PTP_ID IS NULL THEN
      SELECT TBL_PT_PROFESSIONAL_SEQ.NEXTVAL INTO :NEW.PK_PTP_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_PT_PROFESSIONAL_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_PT_THEMATIC_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_PT_THEMATIC_TRG" 
BEFORE INSERT ON TBL_PT_THEMATIC 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
...
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_PT_THEMATIC_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_THEMATIC_CORE_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_THEMATIC_CORE_TRG" 
BEFORE INSERT ON TBL_THEMATIC_CORE 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
...
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_THEMATIC_CORE_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_THEMATIC_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_THEMATIC_TRG" 
BEFORE INSERT ON TBL_THEMATIC 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_TH_ID IS NULL THEN
      SELECT TBL_THEMATIC_SEQ.NEXTVAL INTO :NEW.PK_TH_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_THEMATIC_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TBL_TRAINING_AREA_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "USER_ESCOM"."TBL_TRAINING_AREA_TRG" 
BEFORE INSERT ON TBL_TRAINING_AREA 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_TA_ID IS NULL THEN
      SELECT TBL_TRAINING_AREA_SEQ.NEXTVAL INTO :NEW.PK_TA_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "USER_ESCOM"."TBL_TRAINING_AREA_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table TBL_GENERAL_PROGRAM
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_GENERAL_PROGRAM" ADD CONSTRAINT "TBL_GENERAL_PROGRAM_PK" PRIMARY KEY ("PK_GP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "USER_ESCOM"."TBL_GENERAL_PROGRAM" MODIFY ("PK_GP_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_ACTIVITY" ADD CONSTRAINT "TBL_ACTIVITY_FK1" FOREIGN KEY ("FK_ACT_CONDITION")
	  REFERENCES "USER_ESCOM"."TBL_CONDITION" ("PK_CON_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "USER_ESCOM"."TBL_ACTIVITY" ADD CONSTRAINT "TBL_ACTIVITY_FK2" FOREIGN KEY ("FK_ACT_ANNEX")
	  REFERENCES "USER_ESCOM"."TBL_ANNEX" ("PK_AX_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_ANNEX" ADD CONSTRAINT "TBL_ANNEX_FK1" FOREIGN KEY ("FK_AX_PROGRAM")
	  REFERENCES "USER_ESCOM"."TBL_PROGRAM" ("PK_PRO_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_COMMENTARY" ADD CONSTRAINT "TBL_COMMENTARY_FK1" FOREIGN KEY ("FK_COM_ACTIVITY")
	  REFERENCES "USER_ESCOM"."TBL_ACTIVITY" ("PK_ACT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_COMPETITION
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_COMPETITION" ADD CONSTRAINT "FK_CT_GENERAL" FOREIGN KEY ("FK_CT_GENERAL")
	  REFERENCES "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_COMPETITION_GENERAL" ADD CONSTRAINT "FK_CG_COMPETITION" FOREIGN KEY ("FK_CG_COMPETITION")
	  REFERENCES "USER_ESCOM"."TBL_COMPETITION" ("PK_CT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_CONDITION" ADD CONSTRAINT "TBL_CONDITION_FK1" FOREIGN KEY ("FK_CON_PROCESS")
	  REFERENCES "USER_ESCOM"."TBL_PROCESS" ("PK_PRC_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_DISTINCTIVE_FEATURE
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_DISTINCTIVE_FEATURE" ADD CONSTRAINT "FK_DF_GENERAL" FOREIGN KEY ("FK_DF_GENERAL")
	  REFERENCES "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_DOCUMENT_VERSION" ADD CONSTRAINT "TBL_DOCUMENT_VERSION_FK1" FOREIGN KEY ("FK_DV_DOCUMENT")
	  REFERENCES "USER_ESCOM"."TBL_DOCUMENT" ("PK_DOC_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_OCCUPATIONAL_PROFILE
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_OCCUPATIONAL_PROFILE" ADD CONSTRAINT "FK_OP_GENERAL" FOREIGN KEY ("FK_OP_GENERAL")
	  REFERENCES "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_PROCESS" ADD CONSTRAINT "TBL_PROCESS_FK1" FOREIGN KEY ("FK_PRC_DOCUMENT")
	  REFERENCES "USER_ESCOM"."TBL_DOCUMENT" ("PK_DOC_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_PROFESSIONAL_PROFILE
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_PROFESSIONAL_PROFILE" ADD CONSTRAINT "FK_PP_GENERAL" FOREIGN KEY ("FK_PP_GENERAL")
	  REFERENCES "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_PROGRAM
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_PROGRAM" ADD CONSTRAINT "FK_PRO_GENERAL" FOREIGN KEY ("FK_PRO_GENERAL")
	  REFERENCES "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE" ADD CONSTRAINT "FK_PT_THEMATIC_CORE" FOREIGN KEY ("FK_PT_THEMATIC_CORE")
	  REFERENCES "USER_ESCOM"."TBL_THEMATIC_CORE" ("PK_TC_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_PT_COMPETITION_G" ADD CONSTRAINT "FK_PTC_COMPETITION_G" FOREIGN KEY ("FK_PTC_COMPETITION_G")
	  REFERENCES "USER_ESCOM"."TBL_COMPETITION_GENERAL" ("PK_CG_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "USER_ESCOM"."TBL_PT_COMPETITION_G" ADD CONSTRAINT "FK_PTC_PROGRAM_THEMATIC" FOREIGN KEY ("FK_PTC_PROGRAM_THEMATIC")
	  REFERENCES "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE" ("PK_PT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_PT_DISTINCTIVE" ADD CONSTRAINT "FK_PTD_DISTINCTIVE" FOREIGN KEY ("FK_PTD_DISTINCTIVE")
	  REFERENCES "USER_ESCOM"."TBL_DISTINCTIVE_FEATURE" ("PK_DF_ID") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_PT_OCCUPATIONAL" ADD CONSTRAINT "FK_PTO_OCCUPATIONAL" FOREIGN KEY ("FK_PTO_OCCUPATIONAL")
	  REFERENCES "USER_ESCOM"."TBL_OCCUPATIONAL_PROFILE" ("PK_OP_ID") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_PT_PROFESSIONAL" ADD CONSTRAINT "FK_PTP_PROFESSIONAL" FOREIGN KEY ("FK_PTP_PROFESSIONAL")
	  REFERENCES "USER_ESCOM"."TBL_PROFESSIONAL_PROFILE" ("PK_PP_ID") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_ESCOM"."TBL_PT_THEMATIC" ADD CONSTRAINT "FK_PTT_PROGRAM_THEMATIC" FOREIGN KEY ("FK_PTT_PROGRAM_THEMATIC")
	  REFERENCES "USER_ESCOM"."TBL_PROGRAM_THEMATIC_CORE" ("PK_PT_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "USER_ESCOM"."TBL_PT_THEMATIC" ADD CONSTRAINT "FK_PTT_THEMATIC" FOREIGN KEY ("FK_PTT_THEMATIC")
	  REFERENCES "USER_ESCOM"."TBL_THEMATIC" ("PK_TH_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_THEMATIC
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_THEMATIC" ADD CONSTRAINT "FK_TH_GENERAL" FOREIGN KEY ("FK_TH_GENERAL")
	  REFERENCES "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_THEMATIC_CORE
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_THEMATIC_CORE" ADD CONSTRAINT "FK_TC_TRAINING_AREA" FOREIGN KEY ("FK_TC_TRAINING_AREA")
	  REFERENCES "USER_ESCOM"."TBL_TRAINING_AREA" ("PK_TA_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TBL_TRAINING_AREA
--------------------------------------------------------

  ALTER TABLE "USER_ESCOM"."TBL_TRAINING_AREA" ADD CONSTRAINT "FK_TA_GENERAL" FOREIGN KEY ("FK_TA_GENERAL")
	  REFERENCES "USER_ESCOM"."TBL_GENERAL_PROGRAM" ("PK_GP_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
