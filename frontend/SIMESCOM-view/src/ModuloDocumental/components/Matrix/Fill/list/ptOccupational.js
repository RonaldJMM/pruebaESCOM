...
class PtOccupational extends Component {
        ...
        if (this.props.messageAdd !== '') {
            switch (this.props.messageAdd) {
                case 'addO':
                    ...
                    this.props.getListRelational(localStorage.getItem('Token'), sessionStorage.getItem('programT'), 'PtOccupational');
    ...
    handleSubmit = formValues => {
        let relationalN = {
            ...
            idRelation: formValues.occupational,
            nameRelation: "",
            table: 'PtOccupational',
            requestData: null
        }
                            ...
                            <div class="modal-content">
                                ...
                                <form className="form-horizontal" onSubmit={this.props.handleSubmit(this.handleSubmit)}>
                                    ...
                                    <div class="modal-body">
                                        <label for="form_control_1">Perfil ocupacional: </label>
                                        <div className="row">
                                            <div className="col-sm">
                                                <Field name="occupational" validate={[select]} className="bs-select form-control" component={generarSelect}>
...
export default withRouter(connect(mapStateToProps, { addMessageAdd, addMessageDelete, getListRelational, addRelational, deleteRelational })(formAddO));