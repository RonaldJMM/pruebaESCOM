...
class PtProfessional extends Component {
        ...
        if (this.props.messageAdd !== '') {
            switch (this.props.messageAdd) {
                case 'addP':
                    ...
                    this.props.getListRelational(localStorage.getItem('Token'), sessionStorage.getItem('programT'), 'PtProfessional');
    ...
    handleSubmit = formValues => {
        let relationalN = {
            ...
            idRelation: formValues.professional,
            nameRelation: "",
        ...
        return (
            <div >
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <button type="button" className="btn text-light btn-sm float-right naranja " data-toggle="modal" data-target="#addProfessional" >
                        <i class="fas fa-plus"></i> Agregar
                    </button>
                    <div class="modal fade" id="addProfessional" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form className="form-horizontal" onSubmit={this.props.handleSubmit(this.handleSubmit)}>
                                    ...
                                    <div class="modal-body">
                                        <label for="form_control_1">Perfil profesional: </label>
                                        <div className="row">
                                            <div className="col-sm">
                                                <Field name="professional" validate={[select]} className="bs-select form-control" component={generarSelect}>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">Nombre del perfil ocupacional</th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody>
...
let formAddP = reduxForm({
    form: 'addProfessional',
    enableReinitialize: true
})(PtProfessional)

export default withRouter(connect(mapStateToProps, { addMessageAdd, addMessageDelete, getListRelational, addRelational, deleteRelational })(formAddP));