        ...
        if (this.props.messageAddO !== '') {
            switch (this.props.messageAddO) {
                case 'addP':
                    ...
                    this.props.getListGeneralC(localStorage.getItem('Token'), sessionStorage.getItem('programId'), 'ProfessionalProfile');
                            ...
                            <div class="modal-content">
                                ...
                                <form className="form-horizontal" onSubmit={this.props.handleSubmit(this.handleSubmit)}>
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Nuevo perfil profesional</h5>
...
export default withRouter(connect(mapStateToProps, { getListGeneralC, deleteGeneralC, addGeneralC, addMessageAdd, addMessageDelete })(formAddP));